  ...
  return (
    <div>
      <div
        ...
        className={`flex items-center gap-2 px-2 py-1.5 rounded-full cursor-pointer text-sm transition ${isSelected ? "bg-violet-100 text-violet-900 border border-violet-200/50" : "hover:bg-white/40 text-slate-700"}`}
      ...
      {isFolder && node.children && (
        <div className="ml-2 border-l border-white/30">
...
export const VisualTree = ({
  ...
  return (
    <div className="bg-white/50 backdrop-blur-xl border border-white/40 rounded-[20px] p-4 h-full overflow-auto flex flex-col">
          ...
          <DialogContent className="bg-white/80 backdrop-blur-2xl border-white/50 rounded-[20px]">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input id="name" placeholder="contoh-file" value={newName} onChange={(e) => setNewName(e.target.value)} className="bg-white/60 rounded-xl mt-1" />
      ...
      <div className="mt-4 p-3 bg-white/40 rounded-xl border border-white/30">
