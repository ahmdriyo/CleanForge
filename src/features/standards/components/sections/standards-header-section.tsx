    ...
    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
      <div>
        ...
        <p className="text-sm text-slate-500">
          Manage all your clean standards
        </p>
      </div>
      <div className="flex items-center gap-3 flex-wrap">
        <Select onValueChange={(v) => onFilter(v ?? "all")} defaultValue="all">
          <SelectTrigger className="w-49 bg-white/80 backdrop-blur border-white/60 rounded-full text-xs">
        ...
        <Link href="/forge/new">
          <Button className="rounded-full bg-violet-600 hover:bg-violet-700 text-white text-xs">
