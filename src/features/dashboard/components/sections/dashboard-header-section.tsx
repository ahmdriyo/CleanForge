...
export const DashboardHeaderSection = () => {
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
      <div>
        <h1 className="text-2xl md:text-3xl font-semibold tracking-tight text-slate-900">Good morning, Alex</h1>
        <p className="text-sm text-slate-500 mt-1">Manage your clean standards and enforce them to every AI Agent.</p>
      </div>
      <Link href="/forge/new">
