...
export const QuickActionsSection = () => {
  return (
    <div className="grid md:grid-cols-2 gap-4 mt-6">
      <Link href="/templates" className="group bg-white/65 backdrop-blur-xl border border-white/60 rounded-[20px] p-5 hover:bg-white/80 hover:border-white/60 transition cursor-pointer">
      ...
      <Link href="/docs" className="group bg-white/65 backdrop-blur-xl border border-white/60 rounded-[20px] p-5 hover:bg-white/80 hover:border-white/60 transition cursor-pointer">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-white border border-white/70 flex items-center justify-center shadow-sm">
