        ...
        <nav className="hidden md:flex items-center gap-8">
          {navLinks.map((l) => (
            <a
              key={l.href}
              href={l.href}
              className="text-sm font-medium text-slate-600 hover:text-violet-900 transition"
            >
              {l.label}
            </a>
          ))}
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link href="/dashboard">
            <Button
              variant="ghost"
              size={"lg"}
              className="rounded-full text-slate-600 hover:text-violet-900 hover:bg-violet-50"
            >
              Login
            </Button>
          </Link>
              ...
              <div className="flex flex-col gap-6 mt-8">
                ...
                <div className="flex flex-col gap-3 pt-6 border-t border-violet-100">
                  <Link href="/dashboard" onClick={() => setOpen(false)}>
                    <Button
                      variant="outline"
                      className="w-full rounded-full border-violet-200"
                    >
                      Login
                    </Button>
                  </Link>
                  <Link href="/dashboard" onClick={() => setOpen(false)}>
                    <Button className="w-full rounded-full bg-gradient-to-br from-violet-950 to-indigo-900 text-white">
                      Start Forging Free
                    </Button>
                  </Link>
                </div>
