...
export const TemplatesPreviewSection = () => {
  ...
  return (
    <section id="templates" className="relative bg-white border-y border-violet-100 py-20 scroll-mt-20 overflow-hidden">
          ...
          {data?.map((tpl, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-3xl border border-violet-100 overflow-hidden hover:shadow-lg transition flex flex-col"
              >
