      ...
      <div className="max-w-[1280px] mx-auto px-4 lg:px-8 flex flex-col md:flex-row gap-8 justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-3">
            © 2026 CleanForge. Built for Gen AI Academy APAC.
          </p>
        ...
        <div className="flex gap-12 text-sm">
          <div className="space-y-2">
            ...
            <a
              href="#features"
              className="block text-slate-500 hover:text-violet-900"
            >
              Features
            </a>
            <a
          ...
          <div className="space-y-2">
            ...
            <Link
              href="https://github.com/ahmdriyo"
              className="block text-slate-500 hover:text-violet-900"
            >
              GitHub
            </Link>
            <a
              href="https://x.com/ahmdriyo"
              className="block text-slate-500 hover:text-violet-900"
            >
              X
            </a>
            <a
              href="https://www.linkedin.com/in/ahmd-riyo/"
              className="block text-slate-500 hover:text-violet-900"
            >
              LinkedIn
            </a>
