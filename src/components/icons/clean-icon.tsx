...
type CleanIconProps = React.SVGProps<SVGSVGElement> & {
  size?: number;
};

export const CleanIcon = ({ size = 20, className, style, ...props }: CleanIconProps) => {
  // Uses currentColor for theming — parent controls color via text-white / text-violet-900 etc.
  // Original broom colors mapped to currentColor with opacity for depth.
  return (
    <svg
      viewBox="0 0 256 256"
      width={size}
